...
export class VisioArchive {
    ...
    toVSDX<T extends keyof VisioArchive.ToVSDXOutputByType = 'blob'>(options?: { type: T }): Promise<VisioArchive.ToVSDXOutputByType[T]>;
}
...
namespace VisioPage {
    ...
    interface FromPaperAttributes {
        exportElement?: (elementView: dia.ElementView, visioPage: VisioPage) => Promise<VisioShape | null>;
        exportLink?: (linkView: dia.LinkView, visioPage: VisioPage) => Promise<VisioShape | null>;
    }

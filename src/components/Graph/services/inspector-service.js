  ...
  getInspectorConfig() {
    const options = {
      colorPalette: [
        {
          content: 'transparent',
          icon: '/statics/assets/transparent-icon.svg'
        },
        { content: '#f6f6f6' },
        { content: '#dcd7d7' },
        { content: '#8f8f8f' },
      ...
      colorPaletteReset: [
        { content: undefined, icon: '/statics/assets/no-color-icon.svg' },
        { content: '#f6f6f6' },
        { content: '#dcd7d7' },
        { content: '#8f8f8f' },
        { content: '#c6c7e2' },
      ...
      imageIcons: [
        {
          value: '/statics/assets/image-icon1.svg',
          content: '<img height="42px" src="/statics/assets/image-icon1.svg"/>'
        },
        {
          value: '/statics/assets/image-icon2.svg',
          content: '<img height="80px" src="/statics/assets/image-icon2.svg"/>'
        },
        {
          value: '/statics/assets/image-icon3.svg',
          content: '<img height="80px" src="/statics/assets/image-icon3.svg"/>'
        },
        {
          value: '/statics/assets/image-icon4.svg',
          content: '<img height="80px" src="/statics/assets/image-icon4.svg"/>'
        }
      ],

      imageGender: [
        {
          value: '/statics/assets/member-male.png',
          content:
            '<img height="50px" src="/statics/assets/member-male.png" style="margin: 5px 0 0 2px;"/>'
        },
        {
          value: '/statics/assets/member-female.png',
          content:
            '<img height="50px" src="/statics/assets/member-female.png" style="margin: 5px 0 0 2px;"/>'
        }
      ],
